...
for(const [key, value] of Object.entries(bookInfo)){
    let listItem = document.createElement("H3");
    listItem.innerHTML = `<img src=${bookImages[key]} width="300" height="350"><br> ` + `Title: ${bookInfo[key].title}<br>Language: ${bookInfo[key].language}<br>Author: ${bookInfo[key].author}<br><br>`;
    bookList.append(listItem);
}
